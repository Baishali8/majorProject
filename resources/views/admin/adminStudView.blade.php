                    ...
                    <div class="">
                        <form class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Fname']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Blood Group</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['BloodGroup']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Phone']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Alt. Phone Number</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['AltPhone']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['AltEmail']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Pan']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['FatherName']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Guardian's Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['GuadianName']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Occupation</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Occupation']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Guardian's Phone</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['GuadianNumber']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Relation With Guardian</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Relation']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Mother's Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['MotherName']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Mother's Occupation</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Occupation2']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['PostOffice']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['C_PostOffice']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Present City</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['C_City']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Present Zip</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['C_Zip']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Present State</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['C_State']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Name Of 10th Examination</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Exam10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th YOP</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['yop10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Standard Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['stdMarks10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Actual Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['actMarks10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Board</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Board10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Medium Of Study</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Medium10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Maths Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Math10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Science Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Sci10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Computer Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['CS10']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Name Of 12th Examination</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['exam12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th YOP</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['YOP12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Standard Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['StdMarks12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Actual Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['ActMarks12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Board</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Board12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Medium Of Study</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Medium12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Maths Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Math12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Physics Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Phy12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Chemistry Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Chem12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Computer Percent</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['CS12']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Entrance Exam Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['bcaentrance']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Entrance Exam Rank</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['bcarank']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Uni. Regis. No.</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Unireg']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Uni. Roll No.</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Uniroll']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Sem 1</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['S1marks']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Sem 2</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['S2marks']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Sem 3</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['S3marks']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Sem 4</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['S4marks']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Sem 5</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['S5marks']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Sem Average</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['avgSem']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Any backlog</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['backlog']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Backlog Subject</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['backSub']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma Exam</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['DipExam']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma YOP</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['DYOP']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma Stream</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['DSTREAM']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma Average</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Davg']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma University</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['DUni']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Year Gap</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Yrgap']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Year Reason</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['Reason']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Physical disablity</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['PhyDisable']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Work Experience</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['workexp']}}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">placement Assistance</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="{{$view['PAneed']}}">
                            </div>
