                ...
                <div class="row my-5">
                    ...
                    <div class="col table-responsive">
                        <table class="table table-stripped table-hover table-responsive rounded shadow-sm">
                            ...
                            <tbody>
                                <tr>
                                <td scope="row"><?php echo e($dt['id']); ?></td>
                                <td><?php echo e($dt['Fname']); ?></td>
                                <td><?php echo e($dt['Uniroll']); ?></td>
                                <td><?php echo e($dt['Phone']); ?></td>
                                <td><?php echo e($dt['Email']); ?></td>
                                <td><a href=<?php echo e("adstudpview/".$dt['id']); ?>>View</a></td>
                                <td><a href=<?php echo e("deleteAdStudPortal/".$dt['id']); ?>>Delete</a></td>
                                <td><a href=<?php echo e("adStudPortalUp/".$dt['id']); ?>>Update</a></td>
                                </tr>
                            </tbody>
...
<?php echo $__env->make('admin/adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TIHProj\project\resources\views/admin/adminStud.blade.php ENDPATH**/ ?>