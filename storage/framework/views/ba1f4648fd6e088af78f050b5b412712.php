    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3 sidebar">
                ...
                <a href="/stud" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fa-sharp fa-solid fa-graduation-cap me-2"></i>Students</a>
                    ...
                    <div class="">
                        <form class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputName1" aria-describedby="nameHelp" value="<?php echo e($data['Student_Name']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputName1" class="form-label fw-bold">Father's Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputName1" aria-describedby="nameHelp" value="<?php echo e($data['Father_Name']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputName1" class="form-label fw-bold">Alternate Mobile Number</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputName1" aria-describedby="nameHelp" value="<?php echo e($data['Alt_mobile']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label fw-bold">Enquiry</label>
                                <textarea class="form-control-plaintext" readonly aria-label="With textarea" style="resize: none;"><?php echo e($data['Enquiry']); ?></textarea>
                            </div>
                        </form>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\TIHProj\project\resources\views/admin/adminViewData.blade.php ENDPATH**/ ?>