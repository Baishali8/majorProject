...
<div class="m-2">
    <img src="./images/Central Library (1).png" class="img-fluid" alt="">
  </div>
  <div class="heading">
    <h1 class="m-5 text-center">Central<span class="text-danger"> Library</span> </h1>
    ...
    <div class="container">
      ...
      <div class="slider">
        <div class="owl-carousel">
          ...
          <div class="slider-card">
            <div class="d-flex justify-content-center items-center mb-4">
              <a href="mca.html" target="_blank"><img src="images/library3.jpeg" alt=""></a>
          ...
          <div class="slider-card">
            <div class="d-flex justify-content-center items-center mb-4">
              <a href="msc.html" target="_blank"> <img src="images/library5.jpeg" alt=""></a>
            </div>
          </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TIHProj\project\resources\views/library.blade.php ENDPATH**/ ?>