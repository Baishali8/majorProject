...
<div class="m-2">
    <img src="./images/studyroom.png" class="img-fluid" alt="">
  </div>
  <div class="heading">
    <h1 class="m-5 text-center">Study<span class="text-danger"> Room</span> </h1>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TIHProj\project\resources\views/studyroom.blade.php ENDPATH**/ ?>