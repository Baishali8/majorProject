        ...
        <div class="owl-carousel">
          <div class="slider-card">
            <div class="d-flex justify-content-center items-center mb-4">
              <img src="./images/index/img1.jpeg" alt="">
            </div>
          ...
          <div class="slider-card">
            <div class="d-flex justify-content-center items-center mb-4">
              <a href="mca.html" target="_blank"><img src="images/MSc-Computer-Science.jpg" alt=""></a>
          ...
          <div class="slider-card">
            <div class="d-flex justify-content-center items-center mb-4">
              <a href="msc.html" target="_blank"> <img src="images/IT.png" alt=""></a>
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TIHProj\project\resources\views/facilities.blade.php ENDPATH**/ ?>