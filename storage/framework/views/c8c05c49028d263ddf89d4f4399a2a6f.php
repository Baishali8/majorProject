                    ...
                    <div class="">
                        <form class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Fname']); ?> <?php echo e($view['Lname']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Course</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Course']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">College</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['College']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Photo</label>
                                <!-- <img src="<?php echo e($view['Photo']); ?>" class="img-fluid" alt=""> -->
                                <img src="<?php echo e(asset('dbstore/'.$view['Photo'])); ?>" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Mobile']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['BloodGrp']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Nationality</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Nationality']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Caste</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Caste']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Guardian']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Guardian Occupation</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['G_ocp']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Guardian Mobile Number</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['G_mobile']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Father</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Father']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Father Occupation</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['F_ocp']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Father Mobile Number</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['F_mobile']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Mother</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Mother']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Mother Occupation</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['M_ocp']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Mother Mobile Number</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['M_mobile']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th School Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t10th_School']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Board</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t10th_Board']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th YOP</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t10th_YOP']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Total Marks</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t10th_Marks']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Percentage</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t10th_Percent']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th English Marks</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t10th_English']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th School Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12th_School']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Board</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12th_Board']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th YOP</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12th_YOP']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Total Marks</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12th_Marks']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Percentage</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12th_Percent']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th English Marks</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12th_English']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Maths/CS/IT/CA Marks </label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12th_Special']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma Institue Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Diploma_School']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma University Name</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Diploma_Univ']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma YOP</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Diploma_YOP']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma Maths/CA/CS/IT Marks</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Diploma_Special']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma Total Marks</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Diploma_Marks']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">CET For BCA and BBA</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['CET']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Graudation Institute</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Grad_Name']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Graudation University</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Grad_Univ']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Graudation YOP</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Grad_YOP']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Graudation Marks/CGPA</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Grad_marks']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Graudation Percentage</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Grad_percent']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Graudation Math/Stat/Phy/CS Marks</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Grad_Special']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">JECA/CET Rank</label>
                                <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['CET_JECA']); ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">10th Marksheet</label>
                                <!-- <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t10thmarksheet']); ?>"> -->
                                <a href="<?php echo e(asset('dbstorepdf/'.$view['t10thmarksheet'])); ?>" target="_blank" class="d-block">Download</a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">12th Marksheet</label>
                                <!-- <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['t12thmarksheet']); ?>"> -->
                                <a href="<?php echo e(asset('dbstorepdf/'.$view['t12thmarksheet'])); ?>" target="_blank" class="d-block">Download</a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Diploma Marksheet</label>
                                <!-- <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Diplomamarksheet']); ?>"> -->
                                <a href="<?php echo e(asset('dbstorepdf/'.$view['Diplomamarksheet'])); ?>" target="_blank" class="d-block">Download</a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="exampleInputID1" class="form-label fw-bold">Graduation Marksheet</label>
                                <!-- <input type="text" class="form-control-plaintext" readonly id="exampleInputID1" aria-describedby="idHelp" value="<?php echo e($view['Gradmarksheet']); ?>"> -->
                                <a href="<?php echo e(asset('dbstorepdf/'.$view['Gradmarksheet'])); ?>" target="_blank" class="d-block">Download</a>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\TIHProj\project\resources\views/admin/adminViewAdStud.blade.php ENDPATH**/ ?>